...
Package: `@endograph/sandbox-runtime@0.0.75-endograph.1`.
...
The only runtime change adapts [upstream PR #447](https://github.com/anthropics/sandbox-runtime/pull/447)
